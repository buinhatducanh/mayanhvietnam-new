...
import { ACCENT, STORES } from "../data";
        ...
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8">
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              { icon: MapPin,title: "Cửa hàng",val: `${STORES.length} chi nhánh toàn quốc`, sub: STORES.map(s => s.city).join(" · "), color: "#22c55e" },
        ...
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight mb-6">{STORES.length} cửa hàng toàn quốc</h2>
