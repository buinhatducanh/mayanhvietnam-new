...
export const metadata = buildPageMetadata({
  ...
  title: 'Thông tin liên hệ — Hotline 0937.148.222 · Email support',
  description:
    'Liên hệ Máy Ảnh Việt Nam — Hotline: 0937.148.222 · Email: info@mayanhvietnam.com · 4 cửa hàng toàn quốc · Hỗ trợ tư vấn MIỄN PHÍ.',
  keywords: [
    'liên hệ máy ảnh',
    'hotline máy ảnh',
    'Máy Ảnh Việt Nam',
          ...
          <FadeIn key={store.id} delay={0.1 + i * 0.1}>
            <div className="rounded-lg bg-card border border-border p-5">
              ...
              <p className="text-xs text-muted-foreground">
                📞 {formatPhone(store.phone)} · 🕐 {store.hours}
              </p>
            </div>
          </FadeIn>
        ))}
