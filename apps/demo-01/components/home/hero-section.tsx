  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 lg:grid-cols-2 lg:px-8 lg:py-20">
        <div className="animate-rise-in">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <Link
              ...
              className="brand-glow-strong group flex items-center gap-2 rounded-full bg-primary px-7 py-3.5 text-sm font-semibold text-primary-foreground transition-all hover:brightness-110"
            >
              Khám phá ngay
              <ArrowRight
        ...
        <div className="animate-rise-in delay-200 relative">
          <div
            aria-hidden="true"
      ...
      <div className="mx-auto max-w-7xl px-4 pb-10 lg:px-8">
        <ul className="animate-rise-in delay-300 grid grid-cols-2 gap-4 rounded-2xl border border-border bg-surface p-5 backdrop-blur-sm lg:grid-cols-4">
          {trustItems.map((item) => (
