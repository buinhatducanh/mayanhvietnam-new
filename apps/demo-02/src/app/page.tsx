...
const productLines = [
  {
    ...
    eyebrow: 'Dòng máy ảnh',
    title: 'Máy ảnh mirrorless & DSLR',
    icon: Camera,
    adSlides: [
      {
        eyebrow: 'Ưu đãi máy ảnh',
        title: 'Full-frame thế hệ mới',
        subtitle: 'Trả góp 0% - Tặng thẻ nhớ 128GB cho đơn hàng máy ảnh trong tháng này.',
        image: '/images/banner-camera.png',
        imageAlt: 'Máy ảnh mirrorless phát sáng xanh',
        primaryCta: { label: 'Mua ngay', href: '/danh-muc/may-anh' },
      },
      {
        eyebrow: 'Body & Kit',
        title: 'Chọn cấu hình của bạn',
        subtitle: 'Tư vấn chọn body và ống kính kit phù hợp nhu cầu và ngân sách.',
        image: '/images/hero-slide-gear.png',
        imageAlt: 'Bộ thiết bị máy ảnh phát sáng xanh',
        primaryCta: { label: 'Nhận tư vấn', href: '/setup-studio' },
      },
    ],
  },
  {
    categorySlug: 'ong-kinh',
    eyebrow: 'Dòng ống kính',
    title: 'Ống kính chính hãng',
    icon: Aperture,
    adSlides: [
      {
        eyebrow: 'Ống kính cao cấp',
        title: 'G Master & L-Series',
        subtitle: 'Đổi ống kính cũ lấy ống kính mới - Định giá minh bạch, thu về giá tốt.',
        image: '/images/banner-lens.png',
        imageAlt: 'Ống kính zoom cao cấp phát sáng xanh',
        primaryCta: { label: 'Khám phá ống kính', href: '/danh-muc/ong-kinh' },
  ...
  },
  {
    ...
    eyebrow: 'Dòng máy quay',
    title: 'Máy quay phim & Cinema',
    icon: Video,
    adSlides: [
      {
        eyebrow: 'Cinema Line',
        title: 'Quay phim chuẩn điện ảnh',
        subtitle: 'Máy quay 4K 120p, hỗ trợ Log & 10-bit cho nhà làm phim chuyên nghiệp.',
        image: '/images/banner-video.png',
        imageAlt: 'Máy quay cinema phát sáng xanh',
  ...
  },
  {
    categorySlug: 'flycam',
    eyebrow: 'Dòng flycam',
    title: 'Flycam & thiết bị bay',
    icon: Drone,
    adSlides: [
      {
        eyebrow: 'Bay cao hơn',
        title: 'Flycam dưới 249g',
        subtitle: 'Quay 4K HDR, tránh vật cản đa hướng - Không cần đăng ký bay.',
        image: '/images/banner-flycam.png',
        imageAlt: 'Flycam bay phát sáng xanh',
