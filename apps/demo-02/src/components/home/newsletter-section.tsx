        ...
        <div className="relative grid gap-10 p-8 lg:grid-cols-2 lg:p-12">
          <div>
            ...
            <Link
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-full border border-border px-6 py-3 text-sm font-semibold transition-colors hover:border-primary hover:text-primary"
            >
              Tìm hiểu thêm
