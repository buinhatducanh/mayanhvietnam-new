...
export const products: Product[] = [
  ...
  P({
    ...
    thumbnail: `${CDN}/image-data/san-pham/24-12/24-12-28/241228113702126/avatar/638709828221852267_may-anh-canon-eos-r50-white-kem-lens-rf-s-18-45mm-chinh-hang.jpg`,
  ...
  P({
    ...
    thumbnail: `${CDN}/asset/imgs/img/banner/Go-ultra-standard-bundle.webp`,
    price: 19500000, originalPrice: 21900000,
    badges: [{ type: 'hot', label: 'Leica 360°' }, { type: 'sale', label: '-11%' }],
    rating: { average: 4.9, count: 64 }, soldPercent: 35,
...
export const categoryBanners: Record<string, { title: string; image: string; href: string }[]> = {
  ...
  'action-camera': [
    ...
    { title: 'Insta360 Go Ultra', image: `${CDN}/asset/imgs/img/banner/Go-ultra-standard-bundle.webp`, href: 'action-camera-insta360' },
