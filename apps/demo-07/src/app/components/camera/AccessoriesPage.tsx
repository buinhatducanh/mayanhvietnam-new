...
import { Star, ShoppingCart, Briefcase, ChevronLeft, ChevronRight } from 'lucide-react'
...
const HERO_SLIDES = [
  {
    brand: 'Kase',
    product: 'Filter Polarizing CPL 67mm',
    tagline: 'Loại bỏ phản xạ ánh sáng, tăng độ tương phản và màu sắc cho ảnh.',
    img: accessories[0].thumbnail,
  },
  {
    brand: 'Peak Design',
    product: 'Travel Tripod Carbon',
    tagline: 'Thiết kế thông minh, khả năng tiếp cận thiết bị nhanh chóng cho những ngày dài sáng tạo.',
    img: accessories[1].thumbnail,
  },
  {
    brand: 'Lowepro',
    product: 'ProTactic BP 450 AW II',
    tagline: 'Sự ổn định tuyệt đối trong hình hài siêu nhẹ, sẵn sàng cùng bạn đến mọi nơi.',
    img: accessories[2].thumbnail,
  },
  {
    brand: 'Canon',
    product: 'Pin Canon LP-E6NH',
    tagline: 'Tốc độ không tưởng, phá vỡ mọi giới hạn lưu trữ cho video 8K và chụp liên tiếp.',
    img: accessories[3].thumbnail,
  }
]

const BRANDS = ['Billingham', 'Peak Design', 'Manfrotto', 'Sandisk', 'B+W']
...
export function AccessoriesPage({ 
  ...
  useSEO(
    'Phụ kiện Máy ảnh Chính hãng | Máy Ảnh Việt Nam',
    'Thẻ nhớ, pin sạc, balo, túi xách, chân máy (tripod), gimbal chống rung và đa dạng phụ kiện nhiếp ảnh chính hãng.'
  )
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Briefcase size={1000} strokeWidth={0.5} color="#141414" />
      </div>

      <SharedNavbar activeItem="Phụ kiện" onNavigate={onNavigate} cartCount={cartCount} />
