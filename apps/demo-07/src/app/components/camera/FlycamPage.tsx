...
import { Star, ShoppingCart, Plane, ChevronLeft, ChevronRight } from 'lucide-react'
import { flycam } from '../../../../lib/mock-data'

// Data
const HERO_SLIDES = [
  {
    brand: 'DJI',
    product: 'Mavic 4 Pro 512GB Creator Combo',
    tagline: 'Định nghĩa lại nghệ thuật điện ảnh trên không với camera Hasselblad 100MP và gimbal xoay 360°.',
    img: flycam[0].thumbnail,
  },
  {
    brand: 'DJI',
    product: 'Mini 5 Pro',
    tagline: 'Nhỏ gọn phi thường — chỉ 249g, không cần đăng ký. Sức mạnh vô song.',
    img: flycam[1].thumbnail,
  },
  {
    brand: 'DJI',
    product: 'Air 3S Fly More Combo',
    tagline: 'Flycam tầm trung mạnh nhất. Camera 1-inch, bay 46 phút.',
    img: flycam[2].thumbnail,
  },
  {
    brand: 'DJI',
    product: 'Mavic Air 2',
    tagline: 'Lựa chọn tầm trung lý tưởng. 4K 60fps, pin 34 phút, OcuSync 10km.',
    img: flycam[3].thumbnail,
  }
]

const BRANDS = ['DJI', 'Autel Robotics', 'FIMI', 'Hubsan']
...
export function FlycamPage({ 
  ...
  useSEO(
    'Flycam & Drone Chính hãng | Máy Ảnh Việt Nam',
    'Flycam, Drone quay phim chuyên nghiệp từ DJI. DJI Mavic, Air, Mini series. Khám phá góc nhìn không giới hạn từ trên cao.'
  )
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Plane size={1000} strokeWidth={0.5} color="#141414" />
      </div>

      <SharedNavbar activeItem="Flycam" onNavigate={onNavigate} cartCount={cartCount} />
