...
import { Star, ShoppingCart, Aperture, ChevronLeft, ChevronRight, Play } from 'lucide-react'
import { cinema } from '../../../../lib/mock-data'

// Data
const HERO_SLIDES = [
  {
    brand: 'Sony',
    product: 'FX3 Cinema Line',
    tagline: 'Kỷ nguyên làm phim kỹ thuật số mới với cảm biến full-frame và hệ thống làm mát tản nhiệt.',
    img: cinema[1].thumbnail,
  },
  {
    brand: 'Blackmagic Design',
    product: 'Pocket Cinema 6K G2',
    tagline: 'Sức mạnh của phim điện ảnh Hollywood nay nằm gọn trong lòng bàn tay.',
    img: cinema[3].thumbnail,
  },
  {
    brand: 'Sony',
    product: 'FX30 Cinema Line',
    tagline: 'Lựa chọn Cinema Line APS-C hàng đầu cho filmmaker chuyên nghiệp.',
    img: cinema[0].thumbnail,
  },
  {
    brand: 'Canon',
    product: 'EOS C70',
    tagline: 'Máy quay Cinema EOS ngàm RF đầu tiên mang lại chất lượng 4K 120p.',
    img: cinema[2].thumbnail,
  }
]

const BRANDS = ['Sony', 'Canon', 'Blackmagic', 'DJI', 'Panasonic', 'RED']

const FILTERS = [
  { group: 'Mức giá', options: ['Dưới 30 triệu', '30–80 triệu', '80–150 triệu', 'Trên 150 triệu'] }
]

export function VideoCameraPage({ 
  onNavigate,
  onAddToCart,
  cartCount = 0
}: { 
  ...
  useSEO(
    'Máy quay phim Chuyên nghiệp | Máy Ảnh Việt Nam',
    'Máy quay phim điện ảnh, máy quay sự kiện và broadcast từ Sony Cinema Line, Canon Cinema, RED, Blackmagic. Giải pháp chuyên nghiệp.'
  )
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Play size={1000} strokeWidth={0.5} color="#141414" fill="#141414" fillOpacity={0.05} />
      </div>

      <SharedNavbar activeItem="Máy quay" onNavigate={onNavigate} cartCount={cartCount} />
