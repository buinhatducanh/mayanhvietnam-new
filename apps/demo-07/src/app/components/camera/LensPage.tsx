...
const HERO_SLIDES = [
  {
    brand: 'Sony',
    product: 'FE 70-200mm f/2.8 GM II',
    tagline: 'Hiệu suất quang học tuyệt đỉnh cho những khoảnh khắc thể thao và hoang dã.',
    img: lenses[2].thumbnail,
  },
  {
    brand: 'Canon',
    product: 'RF 24-70mm f/2.8L IS USM',
    tagline: 'Định nghĩa lại ống kính zoom standard với chất lượng quang học L-series đỉnh cao.',
    img: lenses[0].thumbnail,
  },
  {
    brand: 'Nikon',
    product: 'Z 24-70mm f/2.8 S II',
    tagline: 'Ống kính zoom standard cao cấp nhất Nikon, lấy nét cực nhanh và im lặng.',
    img: lenses[3].thumbnail,
  },
  {
    brand: 'Canon',
    product: 'RF 50mm f/1.8 STM',
    tagline: 'Nifty fifty giá trị nhất Canon RF, lựa chọn hoàn hảo cho nhiếp ảnh chân dung.',
    img: lenses[1].thumbnail,
  }
]

const BRANDS = ['Canon', 'Sony', 'Fujifilm', 'Nikon', 'Sigma', 'Tamron', 'Viltrox']

const FILTERS = [
  { group: 'Mức giá', options: ['Dưới 5 triệu', '5–10 triệu', '10–20 triệu', 'Trên 20 triệu'] }
]
...
export function LensPage({ 
  ...
  useSEO(
    'Ống kính Chính hãng | Máy Ảnh Việt Nam',
    'Chuyên trang ống kính máy ảnh (Lens) cao cấp từ Canon RF/EF, Sony FE/E, Fujifilm X, Nikon Z. Chất lượng quang học đỉnh cao.'
  )
  ...
  return (
    <div style={{
      ...
      <SharedNavbar activeItem="Ống kính" onNavigate={onNavigate} cartCount={cartCount} />
            ...
            <div key={i} style={{
              ...
              transform: i === currentSlide ? 'scale(1)' : 'scale(1.05)'
               ...
               <div style={{ flex: '1', position: 'relative' }}>
                  <img src={slide.img} style={{ width: '100%', height: '100%', objectFit: 'contain', mixBlendMode: 'multiply', filter: 'sepia(0.1) contrast(1.05)' }} />
