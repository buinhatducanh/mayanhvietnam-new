...
export default function StoreFooter() {
  return (
    <footer className="bg-zinc-950 text-zinc-300 border-t border-zinc-800">
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:left-6 sm:right-auto z-50 flex flex-row sm:flex-col gap-3">
        <a
          href="https://zalo.me/2875467351509223987"
          target="_blank"
          rel="noopener noreferrer"
          className="w-11 h-11 sm:w-12 sm:h-12 bg-blue-600 hover:bg-blue-500 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-11 h-11 sm:w-12 sm:h-12 bg-[#0084FF] hover:bg-[#0073E6] rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110"
        ...
        <a
          href="tel:0907215252"
          className="w-11 h-11 sm:w-12 sm:h-12 bg-emerald-600 hover:bg-emerald-500 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110"
